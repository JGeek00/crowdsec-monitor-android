...
class IpOwnersStatisticsApiClient internal constructor(private val httpClient: HttpClient) {

    private val service: Service by lazy { httpClient.retrofit.create(Service::class.java) }

    suspend fun fetchIpOwnersStatistics(): HttpResponse<List<TopIpOwner>> {
        return try {
            val response = service.fetchIpOwnersStatistics()
    ...
    private interface Service {
        ...
        suspend fun fetchIpOwnersStatistics(): Response<List<TopIpOwner>>
    }
}