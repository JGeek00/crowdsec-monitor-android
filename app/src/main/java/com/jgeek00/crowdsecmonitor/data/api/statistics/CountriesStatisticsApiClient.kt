...
class CountriesStatisticsApiClient internal constructor(private val httpClient: HttpClient) {

    private val service: Service by lazy { httpClient.retrofit.create(Service::class.java) }

    suspend fun fetchCountriesStatistics(): HttpResponse<List<TopCountry>> {
        return try {
            val response = service.fetchCountriesStatistics()
    ...
    private interface Service {
        ...
        suspend fun fetchCountriesStatistics(): Response<List<TopCountry>>
    }
}