...
fun AllowlistsResultContent(
    ...
    Box(
        ...
        when {
            ...
            viewModel.allowlistsResult != null -> {
                val data = viewModel.allowlistsResult!!
                Column(
                    modifier = Modifier
                        .fillMaxSize()
                    ...
                    SectionHeader(
                        text = stringResource(R.string.ip_addresses_in_allowlists),
                    ...
                    data.results.forEachIndexed { index, result ->
                        RoundedCornersListTile(
                            ...
                            Column(modifier = Modifier.fillMaxWidth()) {
                                ...
                                val allowlist = result.allowlist
                                if (allowlist == null) {
                                    Text(
                                        text = stringResource(R.string.not_in_any_allowlist),
                                    ...
                                    Text(
                                        text = stringResource(R.string.allowlist_label, allowlist),
                                        style = MaterialTheme.typography.bodySmall,
