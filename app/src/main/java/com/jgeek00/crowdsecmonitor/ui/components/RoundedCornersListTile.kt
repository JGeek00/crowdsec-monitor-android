    ...
    if (onClick != null) {
        SegmentedListItem(
            ...
            colors = ListItemColors(
                ...
                disabledLeadingContentColor = MaterialTheme.colorScheme.surface.copy(alpha = 0.38f),
                disabledTrailingContentColor = MaterialTheme.colorScheme.surface.copy(alpha = 0.38f),
                disabledOverlineContentColor = MaterialTheme.colorScheme.surface.copy(alpha = 0.38f),
                disabledSupportingContentColor = MaterialTheme.colorScheme.surface.copy(alpha = 0.38f),
